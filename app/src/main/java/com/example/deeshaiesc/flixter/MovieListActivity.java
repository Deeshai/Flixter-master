...
public class MovieListActivity extends AppCompatActivity
{
    ...
    public final static String API_BASIC_URL = "https://api.themoviedb.org/3";
    ...
    {
        //create the URL
        String url = API_BASIC_URL + "/movie/now_playing";
    ...
    {
        //create the URL
        String url = API_BASIC_URL + "/configuration";
        ...
        client.get(url, params, new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response)
            {
                ...
                try {
                    ...
                    Log.i(TAG, String.format("Loaded configuration with imageB aseUrl %s and posterSize %s", config.getImageBaseUrl(), config.getPosterSize()));
    ...
    private void logError(String message, Throwable error, boolean alertUser)
    {
        ...
        //a;ert the user to avoid silent errors
        if (alertUser)
        {
